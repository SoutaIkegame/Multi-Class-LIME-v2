...
中間発表の現行デッキは`docs/MIDTERM_PRESENTATION_WITH_RESULTS_V2_2026-09-09.pptx`。元の導入10枚を維持し、評価設計、実験設定、RF主結果、BB別比較、特徴役割による解釈性評価、次元数・クラス数別の計算時間、2枚の詳細考察、まとめの9枚を追加している。結果グラフは`results/*.png`の画像を使用し、各追加スライドに「このスライドの主張」を明示している。実験設定表はPowerPoint上で編集可能。
